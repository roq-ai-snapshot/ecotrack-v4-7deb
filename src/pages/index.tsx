  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Elevate Your Sustainability Journey with EcoTrack v4: Empowering Organizations to Monitor Carbon Footprint, Streamline Waste Management, and Implement Sustainable Practices for a Greener Future."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Elevate Your Sustainability Journey with EcoTrack v4: Empowering Organizations to Monitor Carbon Footprint, Streamline Waste Management, and Implement Sustainable Practices for a Greener Future.`}
            </Text>
