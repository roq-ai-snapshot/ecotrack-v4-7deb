    ...
    <AppLayout>
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl id="carbon_emissions" mb="4" isInvalid={!!formik.errors?.carbon_emissions}>
            <FormLabel>Carbon Emissions</FormLabel>
            <NumberInput
              name="carbon_emissions"
              value={formik.values?.carbon_emissions}
              onChange={(valueString, valueNumber) =>
                formik.setFieldValue('carbon_emissions', Number.isNaN(valueNumber) ? 0 : valueNumber)
              }
            >
              <NumberInputField />
              <NumberInputStepper>
            ...
            {formik.errors.carbon_emissions && <FormErrorMessage>{formik.errors?.carbon_emissions}</FormErrorMessage>}
          </FormControl>
